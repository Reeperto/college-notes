...
\begin{frame}
    \begin{center}
        \includesvg[width=0.6\pagewidth]{../figures/overlayed.svg}
    \end{center}
\end{frame}
...
\begin{frame}
    \begin{columns}
        \begin{column}{0.5\pagewidth}
            \begin{figure}[t]
                \centering
                \includesvg[width=0.9\textwidth]{../figures/overlayed_g1.svg}
            \end{figure}
        \end{column}
        \begin{column}{0.5\pagewidth}
            \begin{figure}[t]
                \centering
                \includesvg[width=0.9\textwidth]{../figures/overlayed_g2.svg}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Triangular Mesh}
    ...
    \begin{column}{0.3\pagewidth}
        \begin{figure}
            ...
            \only<4>{\includegraphics[width=0.3\pagewidth]{../figures/vase_face_highlight.png}}
        \end{figure}
    \end{column}
    \end{columns}
\end{frame}
